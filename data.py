...
class Data():
    ...
    def __init__(self):
        ...
        self.expenses = [
                ...
                ,['Rent', 10, 1, '1650','Rent']
                ,['Restaurant', 9, 10, '1.66','Cafetaria']
                ,['Restaurant', 9, 9, '29.52','Pizza Hut']
                ,['Restaurant', 9, 8, '26.52','Chinese Buffet']
                ,['Credit/Loans', 8, 8, '453.20','Federal Loan']
                ,['Restaurant', 8, 7, '40.76','Hibachi Grill']
                ,['Auto', 8, 7, '40.45','Lumina Gas']
                ,['Restaurant', 7, 6, '10.55','Taco Bell']
                ,['Restaurant', 7, 5, '2.22','Cafetaria']
                ,['Auto', 7, 4, '29.45','Prius Gas']
                ,['Restaurant', 6, 4, '9.19','Bar']
                ,['Restaurant', 6, 3, '8.12','Burger King']
                ,['Restaurant', 6, 3, '15.20','Taco Bell']
                ,['Restaurant', 5, 2, '1.66','Cafetaria']
                ,['Rent', 5, 1, '1650','Rent']
                ,['Restaurant', 5, 10, '1.66','Cafetaria']
                ,['Restaurant', 4, 9, '29.52','Pizza Hut']
                ,['Restaurant', 4, 8, '26.52','Chinese Buffet']
                ,['Credit/Loans', 4, 8, '453.20','Federal Loan']
                ,['Restaurant', 3, 7, '40.76','Hibachi Grill']
                ,['Auto', 3, 7, '40.45','Lumina Gas']
                ,['Restaurant', 3, 6, '10.55','Taco Bell']
                ,['Restaurant', 2, 5, '2.22','Cafetaria']
                ,['Auto', 7, 2, '29.45','Prius Gas']
                ,['Restaurant', 2, 4, '9.19','Bar']
                ,['Restaurant', 1, 3, '8.12','Burger King']
                ,['Restaurant', 1, 3, '15.20','Taco Bell']
                ,['Restaurant', 1, 2, '1.66','Cafetaria']
                ,['Rent', 1, 1, '1650','Rent']
                ]
